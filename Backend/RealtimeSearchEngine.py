...
System = f"""
Hello, I am {Username}. You are a very accurate and advanced AI chatbot named {Assistantname} which has real-time up-to-date knowledge.
...
# Predefined chatbot conversation system message and initial messages
SystemChatBot = [
